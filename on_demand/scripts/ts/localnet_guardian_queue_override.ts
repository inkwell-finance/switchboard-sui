...
console.log("Initializing LOCALNET Guardian Queue Setup");
...
const switchboardObjectAddress = ON_DEMAND_LOCALNET_STATE_OBJECT_ID;
...
for (const guardian of solanaOracles) {
  if (allOracles.find((o) => o.oracleKey === guardian.pubkey.toBase58())) {
    ...
    await Oracle.initTx(sb, guardianTx, {
      stateObjectId: ON_DEMAND_LOCALNET_STATE_OBJECT_ID,
